...
export function Login() {
  ...
  return (
      <div className="h-screen flex items-center justify-center bg-cover bg-center px-4 sm:px-6 lg:px-8"
      ...
      >
        <div className="w-full max-w-md bg-white bg-opacity-30 backdrop-blur-md rounded-lg p-6 sm:p-8 shadow-xl">
          <div className="flex flex-col items-center text-center mb-6">
            <Link to="/">
              <img src="https://micro-front-end-sport-ecommerce-homepage.vercel.app/logo.png" alt="Logo" className="h-20 sm:h-24 mb-3" />
            </Link>
          ...
          <div className="mt-5 text-sm flex flex-col sm:flex-row justify-between">
            <Link to="/forgotpassword" className="text-gray-700 hover:underline">
              Forgot password?
            </Link>
